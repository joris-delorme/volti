        ...
        <div className="p-8 pb-16 h-screen flex items-center">
            <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
                ...
                <div className="flex flex-col space-y-2 text-center">
                    <h1 className="text-2xl font-semibold tracking-tight">Inscrivez-vous</h1>
                    <p className="text-sm text-muted-foreground">Entrez vos informations en dessous pour créer un compte.</p>
                </div>
                ...
                <Button className="mt-10" size='lg' onClick={() => handler()} disabled={loading}>{loading && <Loader />}Créer un compte</Button>

                <Link to='/signin' className="text-center pt-10 absolute bottom-12 left-1/2 -translate-x-1/2">Vous avez déjà un compte <span className="underline">Connectez-vous</span> ?</Link>
            </div>
        </div>
    )
}
